  <div class="col-md-4">
          ...
          <!-- Search Widget -->
          <div class="card mb-4">
            <h5 class="card-header" style="font-family: 'Times New Roman', Times, serif;">Search</h5>
            <div class="card-body">
        ...
        <input type="text" name="searchtitle" class="form-control" placeholder="Search for..." required>
          ...
          <!-- Categories Widget -->
          <div class="card my-4">
            <h5 class="card-header" style="font-family: 'Times New Roman', Times, serif;">Kategori</h5>
            <div class="card-body">
              <div class="row">
                <div class="col-lg-6">
...
<?php } ?>
          ...
          <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header" style="font-family: 'Times New Roman', Times, serif;">Berita Terbaru</h5>
            <div class="card-body">
                      <ul class="mb-0">
<?php
...
?>
  ...
  <li>
   ...
   <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header" style="font-family: 'Times New Roman', Times, serif;">Berita Terpopuler <br> (Banyak dikunjungi)</h5>
